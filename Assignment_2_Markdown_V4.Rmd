...
```{r}
training_data<- read.csv("D:/MBD/Machine Learning II/Assignment_2/Training_data.csv")
test_data<- read.csv("D:/MBD/Machine Learning II/Assignment_2/Test_data.csv")
labels_data<- read.csv("D:/MBD/Machine Learning II/Assignment_2/Labels.csv")
```
...
We have include the relevant variables we previously found in a new model increasing the nodesize to 3. It takes 6 minutes to process and the result is 0.8180
```{r}
start_time <- Sys.time()
...
Predict with the random forest 5.1 in the test dataset (Best obtained result 0.8180)
```{r}
...
write.csv(submission, 
          file = "D:/MBD/Machine Learning II/Assignment_2/submission_v10.csv", 
          row.names=FALSE)
```
